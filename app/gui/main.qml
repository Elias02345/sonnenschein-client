...
ApplicationWindow {
    ...
    // to allow the user to work with Sonnenschein on a second display
    // while dealing with configuration issues. This will ensure
    // machines come online even if the input focus isn't on Sonnenschein.
    Timer {
        id: inactivityTimer
        interval: 5 * 60000
        onTriggered: {
    ...
    header: ToolBar {
        ...
        RowLayout {
            ...
            NavigableToolButton {
                ...
                {
                    ToolTip.text = qsTr("Update available for Sonnenschein: Version %1").arg(version)
    ...
    ErrorMessageDialog {
        ...
        text: qsTr("No functioning hardware accelerated video decoder was detected by Sonnenschein. " +
    ...
    NavigableMessageDialog {
        ...
        text: qsTr("This version of Sonnenschein isn't optimized for your PC. Please download the '%1' version of Sonnenschein for the best streaming performance.").arg(SystemProperties.friendlyNativeArchName)
        onAccepted: {
    ...
    ErrorMessageDialog {
        ...
        text: qsTr("Sonnenschein detected gamepads without a mapping:") + "\n" + unmappedGamepads
        helpTextSeparator: "\n\n"
